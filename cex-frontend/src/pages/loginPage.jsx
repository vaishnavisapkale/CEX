  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-200 font-sans antialiased flex flex-col items-center justify-center px-5">
     ...
     <div className="w-full max-w-sm bg-zinc-900/80 border border-zinc-800 rounded-2xl p-8 shadow-2xl backdrop-blur">
        <div className="font-mono text-xs tracking-widest uppercase mb-3 text-center" style={{ color: "#ff8600" }}>Sign in</div>
        <h1 className="text-3xl font-semibold tracking-tight text-white text-center mb-2">Welcome back</h1>
        <p className="text-sm text-zinc-500 text-center mb-8">Trade crypto on a transparent order book.</p>
        ...
        <p className="text-sm text-zinc-500 text-center mt-6">
          New here? <Link to="/signup" className="text-[#ff8600] hover:text-[#e05500]">Create an account</Link>
        </p>
      </div>
    </div>
  );
